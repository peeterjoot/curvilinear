...
The final reduction is left as a problem for the student.  The masochistic student may want to compare that reduction to the conventional Jacobian volume element determinant expansion
